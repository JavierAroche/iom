...
;(function(window) {
    ...
    function iom() {
		...
		this.settings = {
			jpg : {
				plugin : ko.observable('jpegtran'),
				plugins : ['guetzli', 'jpegtran', 'jpegoptim', 'mozjpg', 'jpgrecompress'],
				params : ko.observable()
			},
			png : {
				plugin : ko.observable('pngquant'),
				plugins : ['pngquant', 'optipng', 'pngcrush', 'zopfli', 'pngout', 'advpng'],
				params : ko.observable()
			},
			svg : {
				plugin : ko.observable('svgo'),
				plugins : ['svgo'],
				params : ko.observable()
			},
			gif : {
				plugin : ko.observable('gifsicle'),
				plugins : ['gifsicle', 'giflossy'],
				params : ko.observable()
			},
		};
    ...
    */
	...
	iom.prototype.setSettings = function(plugin, type) {
		this.settings[type].plugin(plugin);
	};
